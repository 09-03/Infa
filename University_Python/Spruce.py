# В данном варианте испольуется библиотека tkinter для отображение окна приложения (установка через cmd: pip install tkinter)
from tkinter import *
...
# Но надо будет немного менять предыдущий файл, так что забейте
def triangle(y):
    z = 0
    p = 0
    q = 0
