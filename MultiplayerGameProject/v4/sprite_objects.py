...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            ...
            'sprite_cacodemon': {
                'sprite': [pygame.image.load(f'sprites/cacodemon/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': -0.2,
                'scale': 1.1,
                'animation': deque(
                    [pygame.image.load(f'sprites/cacodemon/anim/{i}.png').convert_alpha() for i in range(9)]),
                'animation_dist': 150,
                'animation_speed': 10,
                'blocked': True,
            },
        ...
        self.list_of_objects = [
            SpriteObject(self.sprite_parameters['sprite_player'], (5.0, 4.5)),
        ]
...
class SpriteObject:
    ...
    def object_locate(self, player):
        ...
        if 0 <= fake_ray <= FAKE_RAYS_RANGE and distance_to_sprite > 30:
            ...
            # Позиционирование спрайта и корректировка его масштаба
